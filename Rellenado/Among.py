...
def among():
	...
	SimpleSeedFill(width, height, 1, verticeslente, xi, yi, 0/255, 255/255, 255/255)
...
def avanzar0among():
	...
	DrawPolygon_(verticeslente, 255/255, 0/255, 0/255, scale)
	DrawPolygon_(verticescuerpo, 255/255, 0/255, 0/255, scale)
	DrawPolygon_(verticesmochila, 255/255, 0/255, 0/255, scale)
	tx = -300
	ty = 0
...
def rellenaragua1():
	...
	DrawPolygon(verticesmochila,  255/255, 255/255, 255/255, 3)
	SimpleSeedFill(width, height, 1, verticescuerpo, xi1, yi1, 255/255, 0/255, 0/255)
	SimpleSeedFill(width, height, 1, verticesmochila,xi2, yi2, 0/255, 0/255, 0/255)
	SimpleSeedFill(width, height, 1, verticeslente, xi, yi, 0/255, 255/255, 255/255)
...
def rellenaragua2():
	...
	DrawPolygon(verticeslente,  255/255, 255/255, 255/255, 3)
	DrawPolygon(verticesmochila,  255/255, 255/255, 255/255, 3)
	SimpleSeedFill(width, height, 1, verticescuerpo, xi1, yi1, 0/255, 0/255, 0/255)
	SimpleSeedFill(width, height, 1, verticesmochila,xi2, yi2, 0/255, 0/255, 0/255)
	SimpleSeedFill(width, height, 1, verticeslente, xi, yi, 0/255, 255/255, 255/255)
...
def rellenaragua2():
	...
	SimpleSeedFill(width, height, 1, verticeslente, xi, yi, 0/255, 0/255, 0/255)
